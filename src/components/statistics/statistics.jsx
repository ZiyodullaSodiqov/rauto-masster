...
function Statistics() {
    ...
    useEffect(() => {
        axios.get('https://test-car.herokuapp.com/news/all')
            .then((response) => {
    ...
    useEffect(() => {
        axios.get('https://test-car.herokuapp.com/announcements/all')
            .then((response) => {
                return response.json();
            })
            .then((data) => {
    ...
    useEffect(() => {
        axios.get('https://test-car.herokuapp.com/sub_categories/all')
            .then((response) => {
                return response.json();
            })
            .then((data) => {
